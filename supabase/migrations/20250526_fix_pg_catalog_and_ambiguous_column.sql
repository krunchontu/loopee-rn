-- Migration: 20250526_fix_pg_catalog_and_ambiguous_column.sql
-- Purpose: Fix PostgreSQL catalog table references and ambiguous column names in functions

-- 1. Fix diagnostic function by using proper catalog table joins
...
-- 2. Fix submission function to resolve ambiguous column references using parameter prefixes
